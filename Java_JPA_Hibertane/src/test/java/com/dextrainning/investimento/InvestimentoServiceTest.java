...
public class InvestimentoServiceTest {
	...
	@Test
	public void buscarTodosOrdenadosPorTrechoDescTest() {
		int quantidade = 100;
		InvestimentoService investimentoService = new InvestimentoService();
	...
	public void buscarTodosMaioresQueMilTest() {
		...
		investimentoService.salvar(criarInvestimento("Investimento 2", 0.25, 1500D)); // dentro
		investimentoService.salvar(criarInvestimento("Investimento 3", 0.25, 1000D)); // dentro
